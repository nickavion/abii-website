...
export default defineConfig({
  ...
  // Native Fonts API: self-hosts + subsets + preloads Open Sans (the ABII brand
  // typeface) and generates metric-adjusted fallbacks. Injected via <Font /> in
  // Layout.astro and consumed through `--font-open-sans` in CustomStyles.astro.
  fonts: [
    {
